            ...
            <div class="grid grid-cols-1 gap-5 lg:grid-cols-12 2xl:grid-cols-12">
                ...
                @if ($user->profile)
                    <div class="lg:col-span-10 2xl:col-span-9">
                        ...
                        <p class="mt-4 text-slate-500 dark:text-zink-200">{{ $user->profile->bio }} </p>
                ...
                @else
                    <div class="lg:col-span-10 2xl:col-span-9">
                        ...
                        <div class="flex gap-3 mb-4">
                            ...
                            <p class="text-slate-500 dark:text-zink-200"><i data-lucide="map-pin"
                                    class="inline-block size-4 ltr:mr-1 rtl:ml-1 text-slate-500 dark:text-zink-200 fill-slate-100 dark:fill-zink-500"></i>
                                Pas de localisation</p>
                        </div>

                        <p class="mt-4 text-slate-500 dark:text-zink-200">Veuillez completer votre profil </p>
                        <div class="flex gap-2 mt-4">
                            <a href=""
                                class="flex items-center justify-center transition-all duration-200 ease-linear rounded size-9 text-sky-500 bg-sky-100 hover:bg-sky-200 dark:bg-sky-500/20 dark:hover:bg-sky-500/30">
                                <i data-lucide="twitter" class="size-4"></i>
                ...
                <div class="2xl:col-span-9">
                        ...
                        <div class="text-center card bg-custom-500 xl:col-span-3">
                            <div class="flex flex-col h-full card-body">
                                ...
                                <div class="mt-5 mb-auto">
                                    ...
                                    <p class="text-custom-200">Felicitations {{ $user->name }} votre profil a ete vue
                                        autant de fois.</p>
                                </div>
                                <div class="p-3 mt-5 rounded-md bg-custom-600">
                                    <h2 class="mb-1 text-white">1054</h2>
                                    <p class="text-custom-200">Ne perdez pas espoir. Nous trouverons un emploi pour vous.
                                    </p>
                                </div>
                            </div>
                        </div><!--end col-->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="mb-2 text-slate-500 dark:text-zink-200">{{ $user->profile->bio }}</p>
                        </div>
                    </div>
                    @else
                    <div class="card">
                        <div class="card-body">
                            <h6 class="mb-3 text-15">Biographie</h6>
                            <p class="mb-2 text-slate-500 dark:text-zink-200">Veuillez complter votre profile</p>
                        </div>
                    </div>
                    @endif
                </div><!--end col-->
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="py-2 text-right text-slate-500 dark:text-zink-200"><a
                                                    ...
                                                    class="text-custom-500">{{ $user->profile->website }}</a></td>
                                        </tr>
                                        <tr>
                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-2">
                                <div class="mb-4">
                                    ...
                                    <input type="text" id="prenom"
                                        ...
                                        placeholder="Enter First Name" value="{{ $user->personne->prenom }}" required>
                                </div>
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" id="postNom"
                                        class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                        placeholder="Enter Last Name" value="{{ $user->personne->postNom }}" required>
                                </div>
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    <label for="zipInput" class="inline-block mb-2 text-base font-medium">Expected salary
                                        <span class="text-red-500">*</span></label>
                        ...
                        <form action="{{route('candidate.store')}}" method="POST" class="create-form23">
                            ...
                            <div class="mb-4">
                                <label for="cityInput" class="inline-block mb-2 text-base font-medium">Biographie <span
                                        class="text-red-500">*</span></label>
