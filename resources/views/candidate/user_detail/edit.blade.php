...
@section('content')
    <div class="container px-4 py-8 mx-auto">
        <div class="flex flex-col items-center">
            <h1 class="text-4xl font-bold text-gray-800 dark:text-gray-100">Edit User Detail</h1>
            <p class="text-gray-600 dark:text-gray-400">Fill in your details</p>
        </div>
        <div class="flex flex-col items-center mt-8">
            <form action="{{ route('user-detail.update', $userDetail) }}" method="POST" class="w-full max-w-lg">
                @csrf
                @method('PUT')
                    ...
                    <div class="w-full px-3">
                        ...
                        <div class="flex">
                            ...
                            <input type="text" name="full_name" id="full_name"
                                ...
                                placeholder="Full Name" value="{{ $userDetail->full_name }}" required>
                            @error('full_name')
                    ...
                    <div class="w-full px-3">
                        ...
                        <div class="flex">
                            ...
                            <input type="email" name="email" id="email"
                                class="rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Email" value="{{ $userDetail->email }}" required>
                            @error('email')
                                <p class="mt-2 text-xs italic text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="w-full px-3">
                        ...
                        <div class="flex">
                            ...
                            <input type="text" name="phone_number" id="phone_number"
                                class="rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Phone Number" value="{{ $userDetail->phone_number }}" required>
                            @error('phone_number')
                                <p class="mt-2 text-xs italic text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="w-full px-3">
                        ...
                        <div class="flex">
                            ...
                            <textarea name="summary" id="summary"
                                class="rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Summary">{{ $userDetail->summary }}</textarea>
                            @error('summary')
                                <p class="mt-2 text-xs italic text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
